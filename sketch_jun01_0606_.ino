...
void loop() {
  ...
  sprintf(pChrBuffer, "%c%d%c%d", '/', EMA_Pal, ',', EMA_Son);
  mySerial.write(pChrBuffer);
//  if(cnt==true){
//    sprintf(pChrBuffer, "%d", EMA_Pal);
//    mySerial.write(pChrBuffer);
//    Serial.flush();
//    cnt=false;
//  }
//  else{
//    sprintf(pChrBuffer1, "%d", EMA_Son);
//    mySerial.write(pChrBuffer1);
//    Serial.flush();
//    cnt=true;
//  }
  delay(300);
  ...
  {
    PleaseCount = i;
    sprintf(pChrBuffer1, "%d", '1');
    sprintf(pChrBuffer1, "%d", PleaseCount);
    mySerial.write(pChrBuffer1);

    Serial.flush();
    Serial.println('0' + PleaseCount);
    delay(500);
  }*/
